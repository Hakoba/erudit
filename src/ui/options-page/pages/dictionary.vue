...
import { BookA, Check, ChevronDown, Pencil, Plus, RotateCcw, Trash2, X } from 'lucide-vue-next'
  ...
  <div class="flex flex-col gap-6">
    <div class="flex flex-wrap items-center justify-between gap-4">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <Button
          size="small"
          :severity="isFormOpen ? 'secondary' : undefined"
    ...
    <SectionPanel class="gap-4">
      ...
      <form
        v-if="isFormOpen"
        class="flex flex-col gap-3 border-b border-line pb-4"
      ...
      >
        <template #list="{ items }">
          <ul class="m-0 flex list-none flex-col divide-y divide-line p-0">
            <li
