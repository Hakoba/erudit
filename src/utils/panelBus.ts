...
export interface PanelState {
  ...
  totalWords: number
  /**
   * Страница вкладки: панель пишет её в источник записи. Адрес вкладки из
   * `usePanelChannel` не годится — заголовка там нет, а адрес мог уйти вперёд
   * от снимка, по которому пользователь жмёт «добавить».
   */
