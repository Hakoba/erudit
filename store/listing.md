...
(нарушение Yellow Argon, 2026-09-09). Названия сервисов — только в документации.
...
• Хотите больше — подключите языковую модель: локальную на своём компьютере
  или облачную по своему ключу. Модель видит контекст, находит фразы и объясняет их.
